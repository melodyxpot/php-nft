...
<section class="mr-top-default mr-bottom-default">
    <div class="wrap box items-flex align-center just-space-between w90 center flex-wrap-dv-small">
        <figure class="img-bigguer-banner-shop w50 w100-dv-small mr-dv-bottom-small">
            <img src="<?= BASE_STORAGE_IMAGES ?>/crypto.jpg" />
        </figure>

        <form method="POST" action="/request-wallet" class="w50 wallet mr-left-default form-request-wallet w100-dv-small mr-none">
            ...
            <button type="submit" name="request-wallet" class="button-black w30 mr-bottom-default w50-dv-small">Register Wallet</button>
