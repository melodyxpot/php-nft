...
<section class="container-auth h100vh items-flex align-center just-center">
    <form method="POST" action="/sign-in" class="wrap w50 box-auth items-flex align-center just-center direction-column w90-dv-small">
        ...
        <button type="submit" name="sign-in" class="button-black w30 center w50-dv-small">Sign In</button>
